...
*
   * @project_name : ᴅᴀʀᴋ ᴅᴇᴠɪʟ-ᴍᴅ
   * @author : Dark-Devil
   * @youtube : https://youtube.com/@doom_music_00?si=U8cbhWZNe_avLBSt
   * @description : DARK-DEVIL-MD ,A Multi-functional whatsapp user bot.
   * @version 1.0.1
*
   * Licensed under the  GPL-3.0 License;
* 
   * Created By Mr Isuru Chamika.
   * © 2023 Dark-Devil-Md.
* 
